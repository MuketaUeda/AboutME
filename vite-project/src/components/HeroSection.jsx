...
export const HeroSection = () => {
    return (
        <section id="hero" className="relative min-h-screen flex flex-col items-center justify-center px-4">
            {/* Grafo de embedding com o stack real, no lugar de um fundo decorativo genérico */}
            <EmbeddingGraph />
            ...
            <div className="container max-w-4xl mx-auto text-center">
                <div className="space-y-6">
                    ...
                    <h1 className="font-display text-4xl md:text-6xl font-bold text-foreground">
                        ...
                        <div className="text-primary opacity-0 animate-fade-in">Full-Stack Engineer</div>
                        {/* Linha "Hi, I'm" */}
                        <div className="text-2xl md:text-4xl mt-4 opacity-0 animate-fade-in-delay-4">Hi, I'm</div>
                        {/* Nome principal */}
                        <div className="text-primary opacity-0 animate-fade-in-delay-5">Gabriel Rosati</div>
                    </h1>
                    ...
                    <p className="text-lg md:text-xl text-foreground/80 mt-8 opacity-0 animate-fade-in-delay-6">
                        I build <span className="text-accent font-medium">AI-powered</span> software, from idea to production.
                    </p>
